  ...
  >
    ...
    <div className={`w-64 hidden md:flex flex-col p-6 border-r ${darkMode ? "border-gray-700 bg-gray-900" : "border-gray-200 bg-white"}`}>
      ...
      <nav className="flex flex-col gap-4 text-sm">
        <a className="hover:opacity-70">📄 Resume Analyzer</a>
        <a className="hover:opacity-70">📊 Analytics</a>
        <a className="hover:opacity-70">🤖 AI Insights</a>
        <a className="hover:opacity-70">⚙️ Settings</a>
      </nav>
